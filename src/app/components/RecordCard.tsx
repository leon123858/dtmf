...
export function RecordCard({ record, deleting, onDetails, onEdit, onDelete }: RecordCardProps) {
	...
	return (
		<article data-record-id={record.id} className={`rounded-lg border px-3 py-2 ${historical ? 'border-gray-200 bg-gray-50' : 'border-gray-200 bg-white shadow-sm'}`}>
			<div className='flex items-center gap-3'>
				<div className='min-w-0 flex-1'>
					...
					<div className='mt-1 flex min-w-0 items-center gap-3 text-sm leading-5 text-gray-600'>
